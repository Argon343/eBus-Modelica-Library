model Test_Betrieb
  ...
  EMOSYN.Bus.Simple_Bus simple_Bus1 annotation(
    Placement(visible = true, transformation(origin = {106, 2}, extent = {{-28, -28}, {28, 28}}, rotation = 0)));
equation
  connect(simple_Bus1.pin_n, simple_Charger1.pin_n) annotation(
    Line(points = {{78, -15}, {55, -15}, {55, -14}, {46, -14}}, color = {0, 0, 255}));
  connect(simple_Bus1.pin_p, simple_Charger1.pin_p) annotation(
    Line(points = {{78, 19}, {48, 19}, {48, 14}, {46, 14}}, color = {0, 0, 255}));
  connect(simple_Bus1.controlBusVehicle, simple_Charger1.controlBusCharger) annotation(
    Line(points = {{130, 30}, {54, 30}, {54, 0}, {46, 0}}, color = {255, 204, 51}, thickness = 0.5));
